...
// `retouching` was merged into `post_production` in PR3 (2026-05-18),
// so the post_production entry now covers both stills retouching and
// video post.
const ARTIST_LABOUR_LINE_TYPES = ['artist_fee', 'usage_licence', 'file_management', 'post_production', 'artist_overtime', 'artist_travel'];
