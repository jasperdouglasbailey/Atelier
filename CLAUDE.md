...
3. **Comms agent expansion** — quote-chase shipped PR#33; remaining: tone variants per client preferred_comms (formal vs casual), brief-clarify auto-trigger when parser confidence < 70 (helpers already in place via PR#32 `bestNextQuestion`).
